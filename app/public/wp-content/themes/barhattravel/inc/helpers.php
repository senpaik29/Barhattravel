...
function bt_tour_categories() {
	return [
		'tours-catalog' => [
			...
			'destinations' => [
				[ 'name' => 'Гродно – Лида',                    'icon' => 'castle',  'sub' => 'По следам гродненских рыцарей и королей',   'image' => 'dest-grodno.jpg' ],
				[ 'name' => 'Брест – Коссово',                  'icon' => 'castle',  'sub' => 'Великий и непокоренный Брест',              'image' => 'dest-brest.jpg' ],
				[ 'name' => 'Жиличи – Красный берег – Гомель',  'icon' => 'map',     'sub' => 'Наследие гомельской земли',                 'image' => 'dest-bobruysk-gomel.jpg' ],
				[ 'name' => 'Пинск – Барановичи',               'icon' => 'compass', 'sub' => 'По следам иезуитов и сказочных животных' ],
				[ 'name' => 'Крево – Новогрудок – Туров',       'icon' => 'castle',  'sub' => 'Навагрудскія таямніцы і Марсіянскія пейзажы', 'image' => 'dest-novogrudok.jpg' ],
			],
			'programs' => [
				[
					'route' => 'Гродно – Лида',
