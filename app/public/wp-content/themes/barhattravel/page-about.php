	...
	<div class="bt-container">
		<div class="bt-feature-row">
			<div class="bt-feature-row__content">
				...
				<p>Победитель конкурса субъектов тур. деятельности в номинации <strong>«Открытие года 2025»</strong>. Сертифицированная тур. фирма. Член <strong>РАТА</strong> (Республиканской Ассоциации Туристических Агентств) с 2024 года.</p>
				<ul>
		...
		<div class="bt-feature-row bt-feature-row--reverse">
			...
			<div class="bt-feature-row__content">
				...
				<ul class="bt-services bt-services--single bt-mt-2">
					...
					<li><strong>Корпоративные туры</strong> — тимбилдинг, интерактивные экскурсионные программы</li>
					<li><strong>Индивидуальные туры</strong> с отдыхом на море</li>
					<li><strong>Экскурсионные туры</strong> и тематические поездки</li>
					<li><strong>Бронирование</strong> отелей, билетов, мест проведения мероприятий</li>
